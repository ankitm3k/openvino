...
// uint8 Slice: dedicated case with values above the int8 range to exercise the unsigned path. Covers
// the u8 output path enabled for a quantized KV cache (GroupQueryAttention int8/int4 dynamic Slice+Concat).
